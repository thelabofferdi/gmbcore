  ...
  return (
    <div className="h-64 md:h-80 w-full bg-white/5 backdrop-blur-2xl p-4 md:p-8 rounded-3xl md:rounded-[3rem] border border-white/10 flex flex-col min-w-0 shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex items-center justify-between mb-4 md:mb-8 relative z-10">
        <div>
          <h3 className="text-[8px] md:text-[10px] font-black text-[#00d4ff] uppercase tracking-[0.3em] italic mb-1">Analyse Bio-Sync</h3>
          <p className="text-base md:text-xl font-black text-white tracking-tight uppercase italic">Flux de Conversion</p>
        </div>
        <div className="flex gap-2 md:gap-4">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-[#00d4ff] shadow-[0_0_8px_#00d4ff]"></div>
            <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest">Clicks</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_#34d399]"></div>
            <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest">Leads</span>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-slate-500 text-sm italic">Aucune donnée disponible</div>
        </div>
      )}
    </div>
  );
